...
%>
	<tr height="30">
		<td align="center" width="100"><%=order.getOrder_number()%>주문번호</td>
		<td width="250">
		...
		<td align="center" width="50"><%= order.getTotal_price()%>금액</td>
		<td align="center" width="100"><%=order.getOrder_date()%></td>
